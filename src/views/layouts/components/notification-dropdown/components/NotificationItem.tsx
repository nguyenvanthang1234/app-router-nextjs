...
import { Avatar, Badge, Box, IconButton, Menu, Typography, TypographyProps, styled, Checkbox } from '@mui/material'
...
import { markReadNotificationAsync } from 'src/stores/notification/actions'
...
const NotificationItem = (props: TProps) => {
  // ** Props
  const { notification, handleDropdownClose, isSelected, handleSelect } = props
  ...
  return (
    <MenuItem disableRipple disableTouchRipple>
      <Box sx={{ width: '100%', display: 'flex', alignItems: 'flex-start' }}>
        <Checkbox checked={isSelected} onChange={handleSelect} onClick={e => e.stopPropagation()} />
